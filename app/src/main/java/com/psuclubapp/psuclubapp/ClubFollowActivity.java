...
public class ClubFollowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_club_follow);
        ...
        listViewFollow = (ListView) findViewById(R.id.clubFollow);
        new showClubFollow().execute(username_sp);
    ...
    public class showClubFollow extends AsyncTask<String, Void, JSONArray> {
        private ProgressDialog progressDialog;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ClubFollowActivity.this);
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            Request request = new Request.Builder().url("http://psuclub.esy.es/PSUClubApp/showClubFollow.php").post(body).build();
        ...
        protected void onPostExecute(JSONArray j) {
            ...
            for (int i = 0; i < j.length(); i++) {
                ...
                listViewFollow.setAdapter(customList);
