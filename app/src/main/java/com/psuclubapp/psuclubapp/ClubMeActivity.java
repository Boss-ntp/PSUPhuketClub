...
public class ClubMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_club_me);
        ...
        listViewMy = (ListView) findViewById(R.id.clubMe);
        new showClubMe().execute(username_sp);
    ...
    public class showClubMe extends AsyncTask<String, Void, JSONArray> {
        private ProgressDialog progressDialog;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ClubMeActivity.this);
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            Request request = new Request.Builder().url("http://psuclub.esy.es/PSUClubApp/showClubMe.php").post(body).build();
        ...
        protected void onPostExecute(JSONArray j) {
            ...
            for (int i = 0; i < j.length(); i++) {
                ...
                listViewMy.setAdapter(customList);

                listViewMy.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
