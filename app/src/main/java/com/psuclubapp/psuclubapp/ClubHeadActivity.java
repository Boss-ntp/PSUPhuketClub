...
public class ClubHeadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_club_head);
        ...
        listViewHead = (ListView) findViewById(R.id.clubHead);
        new showClubHead().execute(username_sp);
    ...
    public class showClubHead extends AsyncTask<String, Void, JSONArray> {
        private ProgressDialog progressDialog;

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ClubHeadActivity.this);
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            Request request = new Request.Builder().url("http://psuclub.esy.es/PSUClubApp/showClubHead.php").post(body).build();
