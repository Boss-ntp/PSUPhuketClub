...
public class ActAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_all);
        ...
        listActAll = (ListView) findViewById(R.id.listActAll);
    ...
    public class load extends AsyncTask<String,Void,JSONArray>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ActAllActivity.this);
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            Request request = new Request.Builder().url("http://psuclub.esy.es/PSUClubApp/showActAll.php").post(body).build();
